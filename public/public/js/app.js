...
function renderVideoResult(data) {
  ...
  const videoThumb = document.getElementById("videoThumbnail") || document.getElementById("videoThumb");
  ...
  if (videoUploader) videoUploader.textContent = data.uploader;
...
function listenToProgress(jobId, videoTitle) {
  ...
  const completedArea = document.getElementById("completedDownloadArea") || document.getElementById("completedActionArea");
